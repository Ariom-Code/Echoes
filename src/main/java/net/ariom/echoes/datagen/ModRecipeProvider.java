...
public class ModRecipeProvider extends RecipeProvider implements IConditionBuilder {
    ...
    private static final List<ItemLike> SMELTABLES = List.of(ModItems.PAGE.get());
    ...
    protected void buildRecipes(Consumer<FinishedRecipe> consumer) {
        oreSmelting(consumer, SMELTABLES, RecipeCategory.MISC, Items.COAL, 0.25f, 100, "page");

    ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModItems.AETHER_EYE.get())
            .pattern("AAA")
            .pattern("ASA")
            .pattern("AAA")
        ...
        while(var9.hasNext()) {
            ...
            SimpleCookingRecipeBuilder.generic(Ingredient.of(new ItemLike[]{itemlike}), pCategory, pResult, pExperience, pCookingTime, pCookingSerializer)
                    .group(pGroup).unlockedBy(getHasName(itemlike), has(itemlike)).save(pFinishedRecipeConsumer,
                              Echoes.MOD_ID + ':' + getItemName(pResult) + pRecipeName + "_" + getItemName(itemlike));
        }
