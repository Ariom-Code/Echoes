package net.ariom.echoes.item.armor.client.model;
...
public class ArmorModel extends EntityModel<LivingEntity> {
    ...
    public ArmorModel(ModelPart root) {
        armorHead = getSave("Head", root);
        armorChest = getSave("Body", root);
        armorRightArm = getSave("RightArm", root);
        armorLeftArm = getSave("LeftArm", root);
        armorRightLeg = getSave("RightLeg", root);
        armorLeftLeg = getSave("LeftLeg", root);
        armorRightBoot = getSave("RightBoot", root);
        armorLeftBoot = getSave("LeftBoot", root);
    }
